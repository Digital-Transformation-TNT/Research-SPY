...
(function () {
  ...
  function callFailure(type, error) {
    ...
    // Đặt TRƯỚC nhánh "establish connection": Chrome thỉnh thoảng gói cùng một sự cố thành
    // hai thông điệp, và lời khuyên của nhánh kia (bấm Reload) sẽ đẩy người dùng lặp lại
    // đúng thao tác vừa gây ra lỗi.
