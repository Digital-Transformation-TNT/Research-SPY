...
| **TikTok Shop** | Kalodata `/product/searchList` + `/video/searchList` (15 nước, từ 2026-09-14) | API nội bộ · phiên kalodata.com · **trừ credit gói** — `docs/tai-lieu-ky-thuat/kalodata-api.md` |
